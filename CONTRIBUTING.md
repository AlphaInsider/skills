...
document its separate and combined installation forms in `README.md`. Do not
copy source-repository caches, local plans, generated strategies, virtual
environments, IDE files, or credentials into this catalog.
